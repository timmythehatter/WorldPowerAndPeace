#!/usr/bin/python3
"""RandomAutoPlayer.py
A variant of the minimal "client" program that 
will run some game or problem-solving session 
by always choosing its next move (operator)
randomly. 

It waits 1 second after each move, so there will
...
def run_session():
  ...
  while(ops):
    ...
    try:
       ...
       print("Exception when applying operator "+op.name)
       print(e)
       return
    time.sleep(1)
