...
Python 3 constructs and has been tested with Python 3.11.
It is designed to work with the textual Interactive Solving Client.
'''
# </METADATA>
...
class State:
    def __init__(self, d=None):
        if d==None:
            d = {'peg1': list(range(N_disks, 0, -1)), 'peg2': [], 'peg3': []}
        self.d = d
